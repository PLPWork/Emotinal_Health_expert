...
readfiles('C:/Files_to_read')
#a_file = open(r'C:/Users/verma/Downloads/TelegramBot-PizzaOrderBot-master/TelegramBot-PizzaOrderBot-master/', encoding='utf-8')

print("%.12f" % docdocsim("file_onw.txt", "file_two.txt"))
print(query("health insurance wall street"))
print(getcount("health"))
print("%.12f" % getidf("health"))
print("%.12f" % querydocsim("health insurance wall street", "file_onw.txt"))
querydocsim("health insurance wall street", "file_two.txt")
