...
#bot=telegram.Bot(token='1981892694:AAHJneQhQ2ZbNi-IjqIZ9qPQ0a3G8ArdCeA')
#updater = Updater(token='1981892694:AAHJneQhQ2ZbNi-IjqIZ9qPQ0a3G8ArdCeA')
...
def orderpizza(bot,update):
    print("inside order pizza : ", update)
